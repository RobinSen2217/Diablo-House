  ...
  <div className="container py-24 min-[1240px]:w-2/3 mx-auto">
    <div className="flex flex-col text-center w-full mb-20 justify-between">
      ...
      <div className="flex mx-auto border-2 border-orange-500 rounded overflow-hidden mt-6">
        <Link to='/' className="py-1 px-4 bg-orange-500 text-white focus:outline-none hover:cursor-pointer">Weekdays</Link>
        <Link to='/end'className="py-1 px-4 text-gray-300 focus:outline-none hover:cursor-pointer">Weekends</Link>
      </div>
