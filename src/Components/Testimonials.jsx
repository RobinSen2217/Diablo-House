...
function Testimonials() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <h1 className="text-5xl font-medium title-font mb-12 text-center text-white font-Mystery">Message from Survivors</h1>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-950 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src="/src/assets/Testi1.jpg" className="w-16 h-16 rounded-full flex-shrink-0 object-cover object-center"/>
      ...
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-950 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src="/src/assets/Testi2.jpg" className="w-16 h-16 rounded-full flex-shrink-0 object-cover object-center"/>
            <span className="flex-grow flex flex-col pl-4">
