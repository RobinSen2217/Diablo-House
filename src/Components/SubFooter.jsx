...
export default function SubFooter() {
  return (
    ...
    <div className='flex max-[567px]:flex-wrap justify-around w-full xl:w-5/6 mx-auto py-20'>
      ...
      <img src="/public/logo-removebg-preview.png" alt="logo" className='min-[567px]:h-44 mx-auto w-44 h-40'/>
      ...
      </span><img src="/public/phone-removebg-preview.png" alt="phone" className='h-10 inline'/>
      +91 99998 77430<br/>
      <img src="/public/location-removebg-preview.png" alt="location"className='inline  h-10' />
