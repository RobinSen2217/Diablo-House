  ...
  <div className="container py-24 min-[1240px]:w-2/3 mx-auto">
    <div className="flex flex-col text-center w-full mb-20 justify-between">
      ...
      <div className="flex mx-auto border-2 border-orange-500 rounded overflow-hidden mt-6">
        <button type='btn' onClick={Weekday} className={`py-1 px-4 text-white ${pricing==1?'bg-orange-500  focus:outline-none':'text-gray-300 focus:outline-none'}`}>Weekdays</button>
        <button type='btn' onClick={Weekend} className={`py-1 px-4 text-white ${pricing==2?'bg-orange-500  focus:outline-none':'text-gray-300 focus:outline-none'}`}>Weekends</button>
      </div>
