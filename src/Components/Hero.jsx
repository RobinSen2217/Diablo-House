    ...
    return (<>
      <div className='h-[86vh] md:h-[85vh] w-full  relative group border-b-8 border-black '>
        <div
          ...
          className='flex w-full h-full flex-col gap-y-7  bg-center bg-cover duration-500 justify-center items-center'
        ...
        {/* Left Arrow */}
        <div className=' group-hover:block absolute top-[50%] -translate-x-0 hover:-translate-x-3  translate-y-[-50%] sm:left-10 text-2xl rounded-full sm:p-2 bg-transparent text-white cursor-pointer left-0 '>
          <BsChevronCompactLeft onClick={prevSlide} size={64} />
        </div>
        {/* Right Arrow */}
        <div className='group-hover:block absolute top-[50%] -translate-x-0 hover:translate-x-3 translate-y-[-50%] sm:right-10 right-0 text-2xl rounded-full sm:p-2 bg-transparent text-white cursor-pointer'>
