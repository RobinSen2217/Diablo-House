...
function Navbar() {
  ...
  <div className="container my-auto lg:px-20 mx-auto flex flex-nowrap md:flex-row items-center">
      <img src="/src/assets/logo-removebg-preview.png" alt="logo" className='h-24 md:h-32'/>
    ...
    <div className="bg-[url('/src/assets/Orange_hexagon.png')] h-24 md:h-28 w-24 flex justify-center items-center text-black bg-center bg-no-repeat bg-cover animate-spin-slow">
